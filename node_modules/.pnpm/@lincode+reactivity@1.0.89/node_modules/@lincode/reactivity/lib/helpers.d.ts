...
export declare const increase: (setState: SetGlobalState<number>, getState: GetGlobalState<number>) => () => void;
export declare const decrease: (setState: SetGlobalState<number>, getState: GetGlobalState<number>) => () => void;
type SetPointer<T> = Array<Set<T>> | [Set<T>];
export declare const add: <A>(setState: SetGlobalState<SetPointer<A>>, getState: GetGlobalState<SetPointer<A>>) => (val: A) => void;
export declare const remove: <A>(setState: SetGlobalState<SetPointer<A>>, getState: GetGlobalState<SetPointer<A>>) => (val: A) => void;
export declare const clear: <A>(setState: SetGlobalState<SetPointer<A>>, getState: GetGlobalState<SetPointer<A>>) => () => void;
